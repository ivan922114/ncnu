//
//  packageMenuTransitionManager.swift
//  motdParser
//
...
class packageMenuTransitionManager: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate {
